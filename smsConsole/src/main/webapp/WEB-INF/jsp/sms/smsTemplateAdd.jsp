...
function createtemplate() {
	...
	if(flag){
		 ...
		 var url = ctx + '/sms/addTemplate.action' ;
			$.ajax({
				url : url,
				global : false,
				type : 'POST',
				data : {'typeCode':typeCode,'appCode':appCode,'title':title,'content':content},
				async : false, //同步
...
<div class="container">
		...
		<div >
			<div>
				...
				<tr>
				<td>短信标题</td>
				<td><input id="title" type="text" /><font color="red">*</font></td>
				</tr>
				...
				<td>
					...
					<textarea id="content" style="height: 80px;width:90%" ></textarea>
					</td>
				</tr>
