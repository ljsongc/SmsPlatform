...
function createchannel() {
	...
	var url = ctx + '/updatechannel.action?name='
			+ name +'&channelContact='+channelContact+'&remark='+remark+'&channelCost='+channelCost+"&id="+id;
	$.ajax({
		url : url,
		global : false,
		type : 'GET',
...
<body>
	...
	<br />
<div class="container">
		<div align="left"><h4>修改短信通道</h4></div>
		</br>
		<div>
			<div>
				<table class="table table-bordered table-striped" width="600px" style="word-break:break-all; word-wrap:break-all;">
				<input id="channelid" value="${smsEntity.id }" type="hidden"/>
				<tr>
				<td>通道名称</td>
				<td><input id="name" value="${smsEntity.name }" /><font color="red">*</font></td>
				</tr>

				<tr>
				<td>通道成本</td>
				<td><input id="channelCost" value="${smsEntity.channelCost }"  /><font color="red">*</font></td>
				</tr>

				<tr>
				<td>通道联系方式</td>
				<td><input id="channelContact" value="${smsEntity.channelContact }" /></td>
				</tr>
				<tr>
				<td>通道备注</td>
				<td><textarea rows="2" cols="40" maxlength="50" id="remark" name="remark">${smsEntity.remark }</textarea></td>
				</tr>
				</table>
					<center>
