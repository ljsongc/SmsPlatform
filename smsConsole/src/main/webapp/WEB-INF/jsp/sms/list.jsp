  	...
  	<script type="text/javascript">
  		$(document).ready(function(){
  			$("#search").click(function(){
  				...
  				window.location.href = "${pageContext.request.contextPath}/sms/search.action"
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="alert alert-info" role="alert">
					<strong>提示：</strong>该查询界面仅用于查询是否成功送达通道，查询实际送达状态，请切换通知送达查询或营销送达查询菜单。
				</div>
			</div>
		</div>
		<div class="row">
		  					...
		  					<tr>
		  						...
		  						<td>
		  							<a class="btn btn-primary btn-xs" 
		  								href="${pageContext.request.contextPath}/sms/view.action?id=${smsEntity.id}">查看</a>
		  						</td>
		  					</tr>
		  				</c:forEach>
		  			</tbody>
