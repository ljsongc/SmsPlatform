  	...
  	<script type="text/javascript">
  		$(document).ready(function(){
  			$("#search").click(function(){
  				...
  				window.location.href = "${pageContext.request.contextPath}/sms/noticeCallbackSearch.action"
		  					...
		  					<tr>
		  						...
		  						<td>
		  							<a class="btn btn-primary btn-xs" 
		  								href="${pageContext.request.contextPath}/sms/noticeCallbackView.action?id=${smsEntity.id}">查看</a>
		  						</td>
		  					</tr>
		  				</c:forEach>
		  			</tbody>
